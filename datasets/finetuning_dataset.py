...
class DataGenerator(Sequence):
    def __init__(self, data_root, file_ids, image_size=(320, 240), batch_size=4, mode='seg',
                 target_classes=["Good Crypts"], filter_classes=[], augment=True, use_edges=False, overload=False):
        """
    ...
    def augment_instance(self, img, masks, bboxes, flip_hor=None, flip_ver=None, rotate_90=None, brightness_factor=None,
    ...
    def get_instance(self, index):
        ...
        if (self.mode == 'seg' or self.mode == 'full') and 'Interpretable Region' in self.target_classes:
            ...
            pink_mass = 255 - (
                        (pink_mass[:, :, 0] > 150) * (pink_mass[:, :, 1] > 150) * (pink_mass[:, :, 2] > 150)) * 255
...
if __name__ == "__main__":
    ...
    train_gen = DataGenerator(data_root, train_ids, img_size, batch_size, 'seg', target_classes, filter_classes,
                              augment=True, use_edges=True, overload=False)
